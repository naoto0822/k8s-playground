...
var file_src_processor_proto_rawDesc = []byte{
	...
	,
...
var file_src_processor_proto_depIdxs = []int32{
	...
	0, // 1: processorpb.ProcessorService.GetRamenList:input_type -> processorpb.GetRamenRequest
	1, // 2: processorpb.ProcessorService.GetRamenList:output_type -> processorpb.GetRamenResponse
...
func (c *processorServiceClient) GetRamenList(ctx context.Context, in *GetRamenRequest, opts ...grpc.CallOption) (*GetRamenResponse, error) {
	out := new(GetRamenResponse)
	err := c.cc.Invoke(ctx, "/processorpb.ProcessorService/GetRamenList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedProcessorServiceServer) GetRamenList(context.Context, *GetRamenRequest) (*GetRamenResponse, error) {
...
func _ProcessorService_GetRamenList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRamenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProcessorServiceServer).GetRamenList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/processorpb.ProcessorService/GetRamenList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProcessorServiceServer).GetRamenList(ctx, req.(*GetRamenRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _ProcessorService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "processorpb.ProcessorService",
	HandlerType: (*ProcessorServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetRamenList",
			Handler:    _ProcessorService_GetRamenList_Handler,
		},
	},
